...
Peoples peoplesModelFromJson(String str) => Peoples.fromJson(json.decode(str));

String peoplesModelToJson(Peoples data) => json.encode(data.toJson());
...
class Peoples {
  ...
  Peoples({this.count, this.next, this.previous, this.results});
